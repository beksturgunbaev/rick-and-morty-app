...
const EpisodesPage = () => {
    ...
    return (
        <div className="bg-slate-900">
            <div className="w-full h-80 overflow-hidden relative flex flex-col justify-center sm:items-center"
                ...
                <h1 className="text-white text-5xl sm:text-6xl font-semibold relative z-10 px-3">The Multiverse Archive</h1>
                <p className="text-white/80 mt-3 text-xl relative z-10 px-3">Database of Rick and Morty’s interdimensional travels.</p>
            </div>
